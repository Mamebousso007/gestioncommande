...
class ArticleEnfant extends StatefulWidget {
  const ArticleEnfant({Key? key}) : super(key: key);

  @override
  State<ArticleEnfant> createState() => _ArticleEnfantState();
}

class _ArticleEnfantState extends State<ArticleEnfant> {
                      ...
                      SliverToBoxAdapter(
                        child: StreamBuilder<QuerySnapshot>(
                          stream: FirebaseFirestore.instance
                              .collection('Produits')
                              .where('categorie', isEqualTo: 'Enfants')
                              .snapshots(),
