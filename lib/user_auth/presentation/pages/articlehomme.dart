...
class ArticleHomme extends StatefulWidget {
  const ArticleHomme({Key? key}) : super(key: key);

  @override
  State<ArticleHomme> createState() => _ArticleHommeState();
}

class _ArticleHommeState extends State<ArticleHomme> {
                      ...
                      SliverToBoxAdapter(
                        child: StreamBuilder<QuerySnapshot>(
                          stream: FirebaseFirestore.instance
                              .collection('Produits')
                              .where('categorie', isEqualTo: 'Hommes')
                              .snapshots(),
